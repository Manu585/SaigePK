...
public class SeismicWave extends EarthAbility implements AddonAbility, ComboAbility {
    ...
    public void setField() {
        ...
        tickDelay = ConfigManager.getConfig().getInt("ExtraAbilities.Hiro3.Earth.SeismicWave.TickDelay");
    ...
    public String getInstructions() {
        return "Become blind -> EarthPulse (Tap Sneak) -> EarthPulse (Left Click) "
                + "-> EarthPulse (Left Click)";
    }
    ...
    @Override
    public void load() {
        ConfigManager.getConfig().addDefault("ExtraAbilities.Hiro3.Earth.SeismicWave.WaveAmount", 1);
        ConfigManager.getConfig().addDefault("ExtraAbilities.Hiro3.Earth.SeismicWave.AngleBetweenPoints", 10);
        ConfigManager.getConfig().addDefault("ExtraAbilities.Hiro3.Earth.SeismicWave.Cooldown", 500);
        ConfigManager.getConfig().addDefault("ExtraAbilities.Hiro3.Earth.SeismicWave.TickDelay", 10);
