...
public class SeismicWave extends EarthAbility implements AddonAbility, ComboAbility {
    ...
    public ArrayList<AbilityInformation> getCombination() {
        ...
        combination.add(new AbilityInformation("EarthPulse", ClickType.SHIFT_UP));
        combination.add(new AbilityInformation("EarthPulse", ClickType.LEFT_CLICK));
        combination.add(new AbilityInformation("EarthPulse", ClickType.LEFT_CLICK));
